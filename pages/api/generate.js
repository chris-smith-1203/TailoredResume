...
3. **Experience Section:**  
   ...
   - Use quantified results (numbers, percentages, metrics) wherever possible.
      When using quantified results (e.g., performance improvements, cost reductions, efficiency gains), always use realistic, non-rounded percentages such as 31%, 42.8%, 27.6% instead of neat numbers like 30%, 40%, or 50%.
      Percentages should look naturally data-driven and believable — avoid round numbers ending in 0 or 5.
